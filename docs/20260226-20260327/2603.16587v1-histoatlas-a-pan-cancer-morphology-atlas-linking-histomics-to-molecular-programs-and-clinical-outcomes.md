...
tags: ["query:cpath"]
score: 9.0
evidence: "将H&E切片的组织组学与分子程序和生存率联系起来"
tldr: "本研究开发了HistoAtlas，这是一个泛癌计算图谱，通过分析21种TCGA癌症类型的6,745张H&E染色切片，提取了38个可解释的组织学特征。该研究系统地将这些特征与患者生存、基因表达、体细胞突变和免疫亚型联系起来，并进行了严格的统计校正。HistoAtlas不仅验证了已知的生物学机制，还发现了新的空间特异性免疫信号和形态学亚型，为从常规病理切片中进行大规模生物标志物发现提供了有力工具。"
selection_source: fresh_fetch
motivation: "旨在通过常规H&E切片建立组织形态学与分子程序及临床结果之间的系统性联系，以实现低成本、大规模的生物标志物发现。"
method: "利用计算病理学技术从21种癌症的6,745张切片中提取38个可解释特征，并结合统计学方法将其与多组学数据和临床预后进行关联分析。"
result: 成功构建了包含空间可追溯特征的泛癌图谱，揭示了与免疫浸润、激酶信号传导及预后相关的多种形态学特征和亚型。
conclusion: HistoAtlas提供了一个开源的交互式平台，证明了仅凭常规病理切片即可进行深入的分子和临床关联研究。
---
