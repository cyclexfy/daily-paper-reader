...
authors: "Hayati, A., Gong, J., Nagesh, V., Avci, P., Ong, A. Y., Masalkhi, M., Engelmann, J., Karouia, F., Keane, P. A., Costes, S. V., Sanders, L. M."
date: 2026-04-30
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.22.720210v2.full.pdf"
tags: ["query:cpath"]
score: 6.5
evidence: 视网膜基础模型的跨物种迁移
tldr: 本研究针对太空生物学数据稀缺问题，评估了人类视网膜基础模型RETFound在大鼠OCT图像年龄估计中的跨物种迁移能力。通过在NASA数据集上对比RETFound+LoRA与Xception模型，发现人类基础模型虽能有效迁移，但在小样本跨物种任务中，传统CNN基准表现更优。该研究为视网膜生物标志物开发提供了重要基准。
source: biorxiv
selection_source: fresh_fetch
motivation: 针对太空生物学成像研究中数据严重稀缺的问题，探索人类视网膜基础模型在跨物种任务中的泛化能力。
method: 采用低秩自适应（LoRA）技术微调RETFound模型，并与预训练的Xception CNN模型在大鼠OCT数据集上进行对比。
result: 实验显示RETFound+LoRA的平均绝对误差为26.20天，而Xception模型以19.01天的误差表现更优。
